/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: c2e65ad021d37b33a6fb22d2e8522619)
...
declare namespace Cloudflare {
	interface Env {
		...
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* web-guilds */;
		SERVICE_EMBLEM: Fetcher /* service-emblem */;
		SERVICE_GW2API: Fetcher /* service-gw2api */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GW2_API_BASE" | "NEXTJS_ENV">> {}
}
